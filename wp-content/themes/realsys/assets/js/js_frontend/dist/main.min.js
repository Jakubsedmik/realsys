...
function popupsController(){this.popups=$(".js-popup")}popupsController.prototype.hideAll=function(){this.popups.removeClass("show"),this.enableScroll()},popupsController.prototype.showPopup=function(e){this.hideAll(),this.popups.each(function(o,t){$(t).attr("id")==e&&$(t).addClass("show")}),this.disableScroll()},popupsController.prototype.hidePopup=function(e){e.closest(".js-popup").removeClass("show"),this.enableScroll()},popupsController.prototype.addListeners=function(e){var o=this;$("body").on("click",".js-openPopup",function(){var e=$(this).attr("data-openmodalid");o.showPopup(e)}),$("body").on("click",".js-closePopup",function(e){var t=$(this).attr("data-callback");t&&"function"==typeof window[t]?window[t]():console.log("function doesnt exist"),o.hidePopup($(this))})},popupsController.prototype.disableScroll=function(){$("body, html").addClass("disableScroll")},popupsController.prototype.enableScroll=function(){$("body, html").removeClass("disableScroll")};var popupsHandler=new popupsController;function cancelUploads(){$("#filepicker").dmUploader("cancel"),resetUploader()}function resetUploader(){var e=$("#uploader .js-progressbar");$(".js-loading-img").show(),$(".js-loadingTitle").show(),$(".js-uploadedImage").hide(),$(".js-attend").addClass("js-disabled").addClass("s7-button--disabled"),$("#url_full").val(""),$("#url_thumb").val(""),e.text("0%"),e.css({width:0})}function setUploader(e){"url_thumb"in e&&"url"in e&&($(".js-uploadedImage").attr("src",e.url_thumb),$(".js-loading-img").hide(),$(".js-loadingTitle").hide(),$(".js-uploadedImage").show(),$(".js-attend").removeClass("js-disabled").removeClass("s7-button--disabled"),$("#url_full").val(e.url),$("#url_thumb").val(e.url_thumb))}function grecaptchaSubmit(){return $(".js-upload").submit(),!0}function grecaptchaSubmit2(){return $(".js-user-details").submit(),!0}function onSubmit(e){document.getElementById("i-recaptcha").submit()}function confirmPopup(e,o){if($(".confirmPopup").length)var t=$(".confirmPopup");else{t='<div class="fshr-confirmPopup">';var s=$(e).attr("data-popuptext")||"Opravdu toto chcete provést",a=$(e).attr("data-popupconfirm")||"Potvrdit",n=$(e).attr("data-popupdeny")||"Zrušit";t+='<div class="fshr-innerConfirmPopup">',t+='<h3 class="">'+s+"</h3>",t+='<div class="fshr-confirmPopupButtons"><button class="fshr-confirm js-confirm">'+a+'</button><button class="fshr-deny js-deny">'+n+"</button></div>",t+="</div>",t+="</div>",t=$(t),$("body").append(t)}t.hide(),t.fadeIn(300),t.on("click",".js-confirm",function(s){window[o](e),t.fadeOut(300)}),t.on("click",".js-deny",function(e){t.fadeOut(300)})}function submitForm(e){$(e).closest("form").submit()}popupsHandler.addListeners(),$("body").on("click touchstart",".js-delegateClick",function(e){var o=$(this).attr("data-delegateelement");$("#"+o).trigger("click")}),$("#filepicker").dmUploader({url:serverData.ajaxUrl,extraData:{action:"file_upload"},maxFileSize:Number(serverData.upload_size),allowedTypes:"image/*",extFilter:["jpg","jpeg"],multiple:!1,fieldName:"uploadedImg",onInit:function(){},onBeforeUpload(e){popupsHandler.showPopup("uploader")},onFileTypeError(e){console.log("ERROR"),alert("Zvolili jste špatný typ souboru")},onUploadProgress(e,o){var t=$("#uploader .js-progressbar");t.text(o+"%"),t.css({width:o+"%"})},onFileSizeError(e){alert("Soubor překročil hranici přípustné velikosti. Prosím vyberte soubor do 10mb")},onUploadSuccess(e,o){"status"in o&&1==o.status?setUploader(o):alert("Došlo k chybě, kontaktujte prosím podporu")},onFileExtError:function(e){alert("Přípona souboru není správná - povolené je pouze jpg a jpeg")}}),$("#user_file_pick").dmUploader({url:serverData.ajaxUrl,extraData:{action:"file_upload"},maxFileSize:Number(serverData.upload_size),allowedTypes:"image/*",extFilter:["jpg","jpeg"],multiple:!1,fieldName:"uploadedImg",onInit:function(){console.log("Callback: Plugin initialized")},onBeforeUpload(e){popupsHandler.showPopup("user_uploader")},onFileTypeError(e){alert("Zvolili jste špatný typ souboru")},onUploadProgress(e,o){var t=$("#user_uploader .js-progressbar");t.text(o+"%"),t.css({width:o+"%"})},onFileSizeError(e){alert("Soubor překročil hranici přípustné velikosti. Prosím vyberte soubor do 10mb")},onUploadSuccess(e,o){"status"in o&&1==o.status?setUploader(o):alert("Došlo k chybě, kontaktujte prosím podporu")}}),$(document).ready(function(){$(".js-user-passwords").validate({rules:{heslo:{required:!0,minlength:6},heslo_potvrzeni:{required:!0,minlength:6,equalTo:"#heslo"}},messages:{heslo:{required:"Heslo musít být vyplněno",minlength:"Heslo musí mit alespoň 6 znaků"},heslo_potvrzeni:{required:"Heslo musít být vyplněno",minlength:"Heslo musí mit alespoň 6 znaků",equalTo:"Hesla se musí shodovat"}}}),$(".js-upload, .js-user-details").validate({rules:{jmeno:{required:!0,minlength:3},prijmeni:{required:!0,minlength:3},email:{required:!0,remote:{url:serverData.ajaxUrl,type:"post",data:{action:"check_email"}}},heslo:{required:!0,minlength:6},heslo_potvrzeni:{required:!0,minlength:6,equalTo:"#heslo"},souhlas_podminky:{required:!0},souhlas_osudaje:{required:!0}},messages:{jmeno:{required:"Jméno musí být vyplněno.",minlength:"Jméno musí mít minimálně 3 znaky"},prijmeni:{required:"Příjmení musí být vyplněno",minlength:"Příjmení musí mít minimálně 3 znaky"},email:{required:"Email musí být vyplněný",email:"Email je ve špatném formátu. Správný formát test@seznam.cz"},heslo:{required:"Heslo musít být vyplněno",minlength:"Heslo musí mit alespoň 6 znaků"},heslo_potvrzeni:{required:"Heslo musít být vyplněno",minlength:"Heslo musí mit alespoň 6 znaků",equalTo:"Hesla se musí shodovat"},souhlas_podminky:{required:"S podmínkami soutěže musíte souhlasit"},souhlas_osudaje:{required:"S podmínkami zpracování os. údajů musíte souhlasit"}},highlight:function(e,o){$(e).addClass("validation-error")},unhighlight:function(e,o){$(e).removeClass("validation-error")},submitHandler:function(e){grecaptcha?grecaptcha.getResponse()?e.submit():(grecaptcha.reset(),grecaptcha.execute()):e.submit()}})}),$(document).ready(function(){$(document).outerWidth()>800&&($("body").hasClass("logged-in")?$(".main-header").sticky({topSpacing:32}):$(".main-header").sticky({topSpacing:0}))}),$(document).ready(function(){$("body").on("click",".js-show-login-wrapper",function(e){e.stopPropagation(),$(".js-searchField-wrapper").removeClass("show"),$(".js-login-wrapper").addClass("show")}),$("body").on("click",".js-login-wrapper.show",function(){e.stopPropagation()}),$("body").on("click",function(e){$(".js-login-wrapper").removeClass("show"),$(".js-searchField-wrapper").removeClass("show")}),$("body").on("click",".js-show-search",function(e){e.stopPropagation(),$(".js-login-wrapper").removeClass("show"),$(".js-searchField-wrapper").addClass("show")}),$("body").on("click",".js-searchField-wrapper.show",function(){e.stopPropagation()})}),$(document).ready(function(e){$("body").on("click",".js-disabled",function(e){e.preventDefault()})}),$(document).ready(function(){$(".lightbox-image").simpleLightbox()}),$(document).ready(function(){$("body").on("click",".js-removePhoto",function(e){var o=$(this).attr("data-removeid"),t=confirm("Opravdu chcete smazat tuto fotografii?"),s=$(this).closest(".galerie-imgbox"),a={remove_id:o,action:"remove_photo",wp_nonce:serverData.ajax_nonce};t&&jQuery.post(serverData.ajaxUrl,a).done(function(e){"status"in e&&1==e.status?(alert("Fotografie byla úspěšně smazána."),s.remove()):alert("Došlo k chybě, nejspíš nejste přihlášeni.")}).fail(function(){alert("Smazání se nezdařilo. Kontaktujte podporu")})})}),$(document).ready(function(){$("body").on("click",".js-launchMobileMenu",function(e){var o=$(".js-mobile-menu");o.hasClass("opened")?(o.slideUp(),o.removeClass("opened")):(o.slideDown(),o.addClass("opened"))})}),$(document).ready(function(){$("body").on("click",".js-change-photo",function(e){e.preventDefault(),resetUploader(),$("#filepicker").trigger("click")})}),$(document).ready(function(){$("body").on("click",".js-let-confirm",function(e){e.preventDefault(),confirmPopup(this,"submitForm")})});