                    ...
                    <div class="row">
                            ...
                            <div class="inz-box align-left">
                                ...
                                <div class="form-row">
                                    <div class="form-field">
                                        ...
                                        <input type="text" placeholder="Např. Jiráskova" name="db_ulice" value="<?php echo $inzerat->dejData("db_ulice"); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Číslo popisné", "realsys" ); ?></label>
                                        <input type="text" placeholder="Např. 15/225" name="db_cp" value="<?php echo $inzerat->dejData("db_cp"); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Město", "realsys" ); ?></label>
                                        <input type="text" placeholder="Např. Chomutov" name="db_mesto" value="<?php echo $inzerat->dejData("db_mesto"); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "PSČ", "realsys" ); ?></label>
                                        <input type="text" placeholder="Např. 225 14" name="db_psc" value="<?php echo $inzerat->dejData("db_psc"); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Městská část", "realsys" ); ?></label>
                                        <input type="text" placeholder="Např. Chomutov - sever" name="db_mestska_cast" value="<?php echo $inzerat->dejData("db_mestska_cast"); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm nazev-popis">
                            <div class="inz-box align-left">
                                ...
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Podlahová plocha (v m2)", "realsys" ); ?></label>
                                        <input type="number" placeholder="Např. 225" value="<?php echo $inzerat->dejData("db_podlahova_plocha"); ?>" name="db_podlahova_plocha">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Pozemková plocha (v m2)", "realsys" ); ?></label>
                                        <input type="number" placeholder="Např. 234" value="<?php echo $inzerat->dejData("db_pozemkova_plocha"); ?>" name="db_pozemkova_plocha">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Titulek", "realsys" ); ?></label>
                                        <input type="text" placeholder="Např. Velký moderní dům v Jiráskově" value="<?php echo $inzerat->dejData("db_titulek"); ?>" name="db_titulek">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-field">
                                        <label><?php echo _e( "Dispozice", "realsys" ); ?></label>
                                        <input type="text" placeholder="Např. 2+kk" value="<?php echo $inzerat->dejData("db_pocet_mistnosti"); ?>" name="db_pocet_mistnosti">
                                    </div>
                                </div>
                                <div class="form-row form-message">
                                    <div class="form-field">
                                        <label><?php echo _e( "Popis", "realsys" ); ?></label>
                                        <textarea placeholder="Např. Prodávám tento krásný dům..." name="db_popis"><?php echo $inzerat->dejData("db_popis"); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3 btn-input">
                        <div class="inz-submit">
                            <button type="submit" class="btn" name="action" value="saveInzerat">
	                            <?php echo _e( "Upravit", "realsys" ); ?>
                            </button>
                        </div>
                    </div>
                </section>
            </form>
            <a href="<?php echo Tools::getFERoute("inzeratClass",$inzerat->getId(), "detail"); ?>" class="btn btn-outline-primary">Zobrazit inzerát</a>
        </div>
    </div>
</section>