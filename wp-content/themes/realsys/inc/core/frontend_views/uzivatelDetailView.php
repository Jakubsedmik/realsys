		...
		<div class="row">
			<div class="col-lg-3">
				...
				<div class="profile-menu-wrap">
					<nav class="profile-menu">
						<ul>
							<li><a id="tab1" class="profile-menu-link active"><?php echo __("Profil uživatele", "realsys"); ?></a></li>
							<li><a id="tab3" class="profile-menu-link"><?php echo __("Inzeráty uživatele", "realsys"); ?></a></li>
						</ul>
					</nav>
				</div>
			...
			<div class="col-lg-9">
				<div class="content-wrap rounded-b shadow-sm p-20 tab-sl-content" id="tab1C">
					<h1 class="sz-tit text-center mb-3 mt-3"><?php echo _e("Profil uživatele ", "realsys"); ?></h1>
				...
				<div class="content-wrap rounded-b shadow-sm p-20 tab-sl-content" id="tab3C">
					<h1 class="sz-tit text-center mb-4 mt-3"><?php echo _e("Inzeráty uživatele", "realsys"); ?></h1>
